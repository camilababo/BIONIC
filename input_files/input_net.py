...
if __name__ == '__main__':
    ...
    # generate_binary_edgelist('../outputs/separate_conditions/scaled_sixteen_mad_probe.csv', '16mad_binary.txt')
    # generate_binary_edgelist('../outputs/separate_conditions/scaled_twenty_five_mad_probe.csv', '25mad_binary.txt')
    generate_random_edgelist('../outputs/separate_conditions/scaled_sixteen_mad_probe.csv', '16mad_random.txt')
    generate_random_edgelist('../outputs/separate_conditions/scaled_twenty_five_mad_probe.csv', '25mad_random.txt')
